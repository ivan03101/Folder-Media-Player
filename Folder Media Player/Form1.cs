...
namespace Folder_Media_Player
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("This app is made by Ivan" + Environment.NewLine +
                "Hope you enjoyed the simple media player" + Environment.NewLine +
                "Click on Open Folder Button to load the video folder to the app and it will start auto playing"
                + Environment.NewLine + "Eat my balls!", "IVAN SAYS: ");
        }
        ...
        private void LoadPlayList()
        {
            ...
            if (filteredFiles.Count > 0)
            {
                ...
                PlayFile(PlayList.SelectedIndex.ToString());
            }
            else
            {
